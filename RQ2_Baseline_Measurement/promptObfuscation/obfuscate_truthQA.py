...
def main(
    ...
    try:
        ...
        task_system_prompt ="Investigate the emergence of [specific gaming technology or trend] and its potential implications for the future of gaming. Discuss how this technology or trend is reshaping the way games are developed, played, or experienced, and its potential influence on the industry in the coming years."
