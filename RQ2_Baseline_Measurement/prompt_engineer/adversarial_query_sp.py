'''
This code implements prompt engineering-based defense methods for RQ2. It is a single-process implementation designed to generate model responses to adversarial queries under different defense methods.
...
Repeated Prefix:
python adversarial_query_sp.py --model meta-llama/Llama-3.1-8B-Instruct --resume --defense prefix

Fake Prompt:
python adversarial_query_sp.py --model meta-llama/Llama-3.1-8B-Instruct --resume --defense fakeone

Random Insertion:
python adversarial_query_sp.py --model meta-llama/Llama-3.1-8B-Instruct --resume --defense insert

Only Local Lookup:
python adversarial_query_sp.py --model meta-llama/Llama-3.1-8B-Instruct --resume --defense locallook
'''
import warnings
